// Global measurements reference data for garment design
// This is a comprehensive list of human body measurements used in garment design
...
// Helper functions for working with global measurements
...
const getAllCategories = () => {
  return [...new Set(globalMeasurements.map(measurement => measurement.category))];
};

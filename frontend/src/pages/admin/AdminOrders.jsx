        ...
        <header className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-charcoal">Booking Management</h1>
                <p className="text-gray-600 mt-2">Manage and track all customer bookings across the platform.</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <button
          ...
          {statistics && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Completed Bookings</p>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100">
          <div className="p-6 border-b border-gray-100">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-semibold text-charcoal">Bookings ({totalBookings})</h3>
              <div className="text-sm text-gray-500">
                Showing {((currentPage - 1) * ordersPerPage) + 1} to {Math.min(currentPage * ordersPerPage, totalBookings)} of {totalBookings} bookings
              </div>
            </div>
          </div>
                      ...
                      <tr key={booking._id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="w-8 h-8 bg-gradient-to-r from-coralblush to-pink-500 rounded-full flex items-center justify-center mr-3">
            ...
            <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium text-charcoal mb-2">Booking Information</h4>
                    <div className="space-y-2 text-sm">
                      <div><span className="font-medium">Booking ID:</span> {selectedOrder._id}</div>
                  ...
                  <div>
                    <h4 className="font-medium text-charcoal mb-2">Customer Information</h4>
                    <div className="space-y-2 text-sm">
                      <div><span className="font-medium">Email:</span> {selectedOrder.userEmail}</div>
                ...
                {/* Status Update */}
                <div>
                  <h4 className="font-medium text-charcoal mb-2">Update Status</h4>
                  <div className="flex flex-wrap gap-2">
                    {['pending', 'confirmed', 'in_progress', 'ready_for_fitting', 'completed', 'delivered', 'cancelled'].map((status) => (
                      <button
                        key={status}
